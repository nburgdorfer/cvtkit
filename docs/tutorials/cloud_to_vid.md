This script creates a video of a point cloud following the provided camera trajectories.
...
parse.add_argument("-m", "--point_cloud", default="cloud.ply", type=str,
        help="Input point_cloud to be captured in video.")
...
parse.add_argument("-v", "--video_file", default="", type=str,
        help="The name of the output video file (with extension). This will be stored in the output path (ex: cloud_vid.avi)")
